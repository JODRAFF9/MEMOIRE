...
\newcommand{\ensaetetesection}[2]{%
  ...
  % Mention « Chapitre n » au-dessus du titre, pour les seuls titres
  % numerotes : le corps du memoire se lit alors en chapitres.
  \ifx\relax#2\relax\else
    {\centering\color{ensaeblue!70}\normalsize\bfseries
     \MakeUppercase{Chapitre}~#2\par}
    \vspace{0.15cm}
  \fi
  {\centering
