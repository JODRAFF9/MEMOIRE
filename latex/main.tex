...
% ── Émulation de \chapter pour la classe article ─────────────
% Les pages liminaires (dédicace, remerciements, etc.) utilisent \chapter*
% qui n'existe pas dans la classe article. On le redéfinit ici.
\makeatletter
...
% \addcontentsline{toc}{chapter}{...} requiert \l@chapter — on le mappe sur \l@section
\providecommand\l@chapter[2]{\l@section{#1}{#2}}
\makeatother
