...
\fancyfoot[L]{\small\itshape Sié Rachid TRAORÉ, ISE3 (ENSAE-DAKAR)}
\fancyfoot[C]{\small\textbf{\{\;{\thepage}\;\}}}
\fancyfoot[R]{\small\itshape 2025-2026}
...
% Bandeau pleine largeur : parbox[c] + 12pt = 2x6pt padding colorbox
\newcommand{\ensaebandeau}[1]{%
  \noindent\colorbox{ensaeblue}{%
    \parbox[c]{\dimexpr\textwidth-12pt\relax}{%
      \vspace{4pt}\centering\color{white}\large\bfseries #1\vspace{4pt}%
    }%
  }%
}

\titleformat{\section}[block]{\normalfont}{}
  {0pt}{\ensaebandeau{\thesection\quad #1}}
