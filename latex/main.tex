...
\newcommand{\nozebre}{\rowcolors{1}{}{}}
% Coefficients des groupes d'age du logit, reference 0 a 4 ans.
% A mettre a jour apres relance de tout.do.
\newcommand{\LogitGrpB}{\textbf{??}}
\newcommand{\LogitGrpBse}{\textbf{(??)}}
\newcommand{\LogitGrpC}{\textbf{??}}
\newcommand{\LogitGrpCse}{\textbf{(??)}}
% Coefficients des classes d'age du chef, reference 35 a 49 ans.
\newcommand{\LogitChefA}{\textbf{??}}
\newcommand{\LogitChefAse}{\textbf{(??)}}
\newcommand{\LogitChefC}{\textbf{??}}
\newcommand{\LogitChefCse}{\textbf{(??)}}
\newcommand{\LogitChefD}{\textbf{??}}
\newcommand{\LogitChefDse}{\textbf{(??)}}
