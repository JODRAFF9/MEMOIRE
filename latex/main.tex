...
% des autres pages.
\titlespacing*{\section}{0pt}{-1.6cm}{8pt}
  ...
  \begin{tikzpicture}
    ...
    \else
      ...
      \node[circle, fill=ensaeblue, draw=white, line width=1.6pt,
        ...
        at (0.925\textwidth,0cm) {#2};
      \draw[ensaecyan, line width=0.7pt, overlay]
        (pastille.center) circle (0.98cm);
    \fi
  \end{tikzpicture}\par
  \endgroup
  % Plancher impose par la pastille : tracee en overlay, elle descend de
  % 0,9 cm sous le filet sans que LaTeX en reserve la place.
  \vspace{0.95cm}
}
