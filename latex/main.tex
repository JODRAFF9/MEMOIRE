...
\definecolor{ensaeblue}{RGB}{0,0,128}        % bleu marine (titres, filets)
...
\usepackage[
  ...
  % en francais : on affiche donc le prenom en entier (Mouhamed Ndiaye,
  % Ameth Saloum Ndiaye). L'option n'agit que sur les homonymes.
  uniquename=full
]{biblatex}
