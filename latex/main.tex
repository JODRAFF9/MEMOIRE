...
% Bordure de page (double filet cyan) dessinee au coin de la feuille via
% eso-pic, SANS remember picture : robuste quel que soit le moteur
% (pdflatex/xelatex) et le nombre de passes. L'ancien mecanisme
% (background + current page) se decalait sous XeLaTeX.
\usepackage{eso-pic}
  ...
  \AtPageLowerLeft{%
    \begin{tikzpicture}[overlay]
      \draw[ensaecyan, line width=3.5pt]
        ([shift={( 10pt, 10pt)}]0,0)
        rectangle
        ([shift={(-10pt,-10pt)}]\paperwidth,\paperheight);
      \draw[ensaecyan, line width=0.8pt]
        ([shift={( 15pt, 15pt)}]0,0)
        rectangle
        ([shift={(-15pt,-15pt)}]\paperwidth,\paperheight);
    \end{tikzpicture}%
  }%
}
