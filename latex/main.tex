...
\newcommand{\ensaetetesection}[2]{%
  \par\noindent
  \begin{tikzpicture}
    % Le filet se deroule depuis la pastille, comme un tapis depuis son
    % rouleau : il court jusqu'au centre du cercle, qui est trace ensuite
    % et recouvre son extremite.
