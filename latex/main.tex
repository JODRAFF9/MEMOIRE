...
% Double filet a coins arrondis (bleu ENSAE + cyan) dont le canal interieur
% est rempli d'orange aux quatre angles.
\usepackage{eso-pic}
% Longueur du remplissage orange le long de chaque bord, depuis l'angle.
\newlength\ensaecoin
\setlength\ensaecoin{34pt}
% Remplit le canal compris entre les deux filets, restreint par #1 a la zone
% d'un angle. La regle even-odd evide le rectangle interieur ; le remplissage
% epouse donc la courbure du coin au lieu de former une equerre a angle droit.
