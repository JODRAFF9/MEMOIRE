...
% En-tete de section : titre centre, puis bandeau epais surmonte de la
% pastille numerotee a droite. #1 = titre, #2 = numero (vide pour une
% section non numerotee, la pastille n'est alors pas tracee).
...
\newcommand{\ensaetetesection}[2]{%
  ...
  \begin{tikzpicture}
    ...
    \else
      % Le bandeau se deroule depuis le bas de la pastille, comme un tapis
      % depuis son rouleau : il court jusqu'au centre du cercle, pose sur
      % lui et donc situe entre le titre et le bandeau. Le cercle etant
      % trace ensuite, l'extremite du bandeau disparait sous le rouleau.
