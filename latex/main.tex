...
\newcommand{\ensaetetesection}[2]{%
  ...
  \begin{tikzpicture}
    \ifx\relax#2\relax
      ...
      \fill[ensaeblue] (0,-3pt) rectangle (\textwidth,3pt);
    \else
      % Le bandeau souligne le titre et la pastille en marque l'extremite
      % droite, centree sur son epaisseur. Le cercle est trace en
      % « overlay » : il deborde de part et d'autre du filet sans entrer
      % dans la boite englobante, faute de quoi il ecarterait le
      % soulignement du titre.
      \fill[ensaeblue] (0,-3pt) rectangle (0.925\textwidth,3pt);
