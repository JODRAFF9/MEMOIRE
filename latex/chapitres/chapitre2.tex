...
\emph{préchargement}. Pour chaque ménage panel, la première section du
questionnaire 2021 affiche à l'enquêteur la liste des membres relevés en 2018,
avec leur identifiant d'origine, leur sexe, leur âge et leur lien de parenté
avec le chef. L'enquêteur confirme la présence de chaque personne, signale les
départs et enregistre les nouveaux arrivants. La variable
\texttt{s01qpreload\_pid} conserve ainsi, pour chaque membre de 2021 déjà
présent en 2018, son identifiant de 2018. C'est cette variable, et non le rang
dans la liste, qui apparie une personne à elle-même.
...
L'unité $i$ est donc l'\emph{enfant}, et non le ménage. Le transfert est certes
...
$p(X_i)$ s'interprète comme la \emph{probabilité qu'un enfant de
caractéristiques $X_i$ vive dans un ménage bénéficiaire}. Le vecteur $X_i$
...
justifications. La première tient à la mesure~: les dimensions MODA
applicables dépendent du groupe d'âge de l'enfant, de sorte qu'apparier au
niveau du ménage reviendrait à traiter comme interchangeables des enfants dont
le bien-être n'est pas évalué sur les mêmes indicateurs. Introduire le sexe et
l'âge dans le score garantit au contraire qu'un enfant traité soit comparé à
des enfants témoins évalués sur les mêmes dimensions. La seconde tient à
l'unité d'analyse~: l'objectif est de mesurer un effet moyen sur les
\emph{enfants}, non sur les ménages, et c'est donc la population d'enfants qui
doit être équilibrée entre traités et témoins.
