...
repose sur le panel vrai des 6\,127 ménages enquêtés lors des deux vagues,
apparié comme le prescrit l'ANSD sur le couple (grappe, ménage) pour les seuls
ménages marqués panel \parencite{ansd2022}. Chaque ménage y est observé en
2018-2019 puis en 2021-2022, ce qui autorise une estimation DD en différences
intra-ménage sans recourir à des hypothèses d'agrégation au niveau des grappes
\parencite{deaton1997}. Le tableau~\ref{tab:panelhh} présente la répartition
des ménages enquêtés en 2021-2022 selon leur statut de suivi et le milieu de
résidence.
...
L'échantillon retenu comprend les enfants de 0 à 17 ans pour lesquels
l'intégralité des indicateurs MODA et la variable de traitement sont
disponibles aux deux vagues. La limite principale de cette construction est
l'attrition différentielle~: si les ménages perdus entre les deux vagues
diffèrent systématiquement des ménages retenus, les estimations peuvent être
biaisées, ce que la section~\ref{sec:discussion} examine.
