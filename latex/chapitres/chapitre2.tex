...
Le tableau~\ref{tab:suivienf} décline cette répartition au niveau des
enfants de l'EHCVM~II. Sur les 31\,033 enfants des ménages enquêtés en
2021-2022, 2\,692 vivent dans un ménage entré dans l'échantillon à la
deuxième vague, 10\,555 appartiennent à un ménage panel sans être
eux-mêmes reliés à une observation de 2018 -- pour l'essentiel des enfants
nés après la première vague ou arrivés dans le ménage entre-temps -- et
17\,786 sont suivis individuellement depuis 2018~: c'est sur ces derniers
que porte l'analyse.

\begin{table}[H]
  \centering
  \caption{Répartition des enfants de l'EHCVM II selon le statut de suivi}
  \label{tab:suivienf}
  \zebre
...
\entete Statut de suivi & $n$ & \% \\
    \hline
    Enfants de nouveaux ménages                     &  2\,692 &   8,7 \\ \hline
    Enfants de ménages panel, non suivis individuellement & 10\,555 &  34,0 \\ \hline
    Enfants suivis individuellement depuis 2018     & 17\,786 &  57,3 \\
    \hline
    Total EHCVM II                                  & 31\,033 & 100,0 \\
    \hline
  \end{tabularx}
