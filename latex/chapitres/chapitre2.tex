...
et 28\,341 en 2021-2022, dont 17\,786 sont suivis individuellement d'une vague
à l'autre selon la procédure décrite ci-après. Sont retenus les enfants pour
lesquels l'intégralité des indicateurs MODA et la variable de traitement sont
disponibles aux deux vagues. Le tableau~\ref{tab:panelhh} donne la répartition
des ménages selon leur statut de suivi et le tableau~\ref{tab:panelenf} les
effectifs d'enfants qui en découlent.
...
\begin{table}[H]
  \centering
  \caption[Effectifs d'enfants de 0 à 17 ans aux différentes étapes de la construction]{Effectifs d'enfants de 0 à 17 ans aux différentes étapes de la construction\protect\footnotemark}
  \label{tab:panelenf}
  \zebre
  \begin{tabularx}{\linewidth}{|X|r|r|}
    \hline
\entete Étape & EHCVM I & EHCVM II \\
    \hline
    Enfants des ménages enquêtés            & 33\,844 & 31\,033 \\ \hline
    Enfants des ménages du panel vrai       & 31\,382 & 28\,341 \\ \hline
    Enfants suivis individuellement aux deux vagues & \multicolumn{2}{r|}{17\,786} \\ \hline
    \quad dont retenus par le score de propension  & \multicolumn{2}{r|}{17\,735} \\ \hline
    \quad dont appariés sur le support commun      & \multicolumn{2}{r|}{8\,076} \\
    \hline
  \end{tabularx}

  {\footnotesize \textit{Source :} Calcul de l'auteur, EHCVM.}
\end{table}
\footnotetext{\textit{Note :} les deux dernières étapes portent sur des enfants observés aux deux vagues, l'effectif est donc commun aux deux colonnes.}

Reste à relier chaque enfant de 2021 à lui-même en 2018. Le rang de l'individu
...
des personnes différentes. Le questionnaire de l'EHCVM~II résout cette
difficulté par un mécanisme de
