...
\entete Étape & EHCVM I & EHCVM II \\
    ...
    Enfants suivis individuellement aux deux vagues & \multicolumn{2}{r|}{17\,786} \\
    \hline
  \end{tabularx}

  {\footnotesize \textit{Source :} Calcul de l'auteur, EHCVM.}
\end{table}
\footnotetext{\textit{Note :} la dernière étape porte sur des enfants observés aux deux vagues, l'effectif est donc commun aux deux colonnes.}

Chaque enfant de 2021 est relié à lui-même en 2018 par le mécanisme de
préchargement du questionnaire de l'EHCVM~II~: pour chaque ménage panel, la
première section affiche à l'enquêteur la liste des membres relevés en 2018 et
la variable \texttt{s01qpreload\_pid} conserve, pour tout membre de 2021 déjà
présent en 2018, son identifiant de 2018. C'est cette variable, et non le rang
dans la liste des membres, qui apparie une personne à elle-même.
