...
\subsection{Covariables du modèle de propension}
...
tout en évitant d'inclure des variables potentiellement affectées par le
traitement~: chacune est mesurée à la période de base (2018) et se rattache à
l'un des cadres théoriques exposés en revue de littérature
(section~\ref{sec:revue}), qui gouvernent conjointement la décision de migrer,
d'envoyer des transferts et, partant, le statut de bénéficiaire du ménage.
...
textes~: la santé et la nutrition au droit à la survie et au meilleur état de
santé possible (art.~24 CIDE~; art.~14 Charte africaine),
l'éducation au droit à l'instruction (art.~28-29 CIDE~; art.~11 Charte
africaine), l'eau, l'assainissement et le logement à un niveau de vie
suffisant (art.~27 CIDE), et la protection de l'enfant au droit d'être
préservé de toute forme d'exploitation, de séparation abusive d'avec ses
parents et à l'enregistrement à la naissance (art.~7, 9 et 32 CIDE~; art.~6
et 15 Charte africaine) \parencite{onu1989,oua1990}, ce qui ancre la mesure
dans une définition normative du bien-être de l'enfant plutôt que dans le
