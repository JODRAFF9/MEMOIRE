...
des deux vagues EHCVM, le statut est défini à la période de base (2018), ce
qui écarte toute causalité inverse des privations vers le traitement~: un
...
tant qu'ancien membre parti en migration - conformément à la théorie des
réseaux, selon laquelle c'est le départ d'un membre qui crée le lien de
transfert. Le groupe témoin rassemble les enfants des ménages ne recevant
aucun transfert de ce type~; les transferts internes et les envois
d'expéditeurs n'ayant jamais appartenu au ménage, qui relèvent d'une
solidarité d'une autre nature, sont écartés \parencite{ndiaye2009}. Le
tableau~\ref{tab:repart_traitement} donne la répartition qui en résulte~:
2\,638 enfants suivis, soit 14,8\,\%, vivent dans un ménage bénéficiaire
