...
\subsubsection{Approche MODA (Multiple Overlapping Deprivation Analysis)}
...
\entete Dimension & Indicateurs de privation & Seuil / Définition & Variables EHCVM \\
    ...
    \hline
    Santé
      & Combustible solide & Bois, charbon ou déchets pour cuisiner & \texttt{combust} \\
    \hline
  ...
  \begin{tablenotes}
    ...
    l'EHCVM sont retenus~: la diversité alimentaire (module \texttt{s08b1},
    2018 uniquement) et l'accès à pied à une structure de santé (module
