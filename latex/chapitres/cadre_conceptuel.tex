...
Les \textbf{transferts de fonds des migrants} désignent les fonds envoyés par
des personnes résidant à l'étranger vers leur pays ou leur région d'origine
\parencite{maimbo2005}. Cette définition appelle trois précisions, qui
commandent la construction de la variable de traitement au chapitre suivant.

Le \textbf{migrant} est ici la personne qui envoie, résidant hors du pays et
ayant appartenu au ménage avant son départ. Ce dernier critère importe, car il
distingue le transfert d'un ancien membre, qui relève d'une solidarité
familiale durable, de l'envoi d'un tiers, dont la logique est différente.

Le \textbf{ménage bénéficiaire} est le ménage qui déclare avoir reçu un tel
transfert au cours de la période de référence de l'enquête. Le statut est
défini au niveau du ménage, faute d'une information sur l'affectation des fonds
à tel ou tel de ses membres.

L'\textbf{enfant}, enfin, est toute personne âgée de moins de dix-huit ans, au
sens de la Convention internationale des droits de l'enfant
\parencite{onu1989}.

\subsection{Les approches de la pauvreté}

La pauvreté a reçu quatre grandes acceptions, dont chacune emporte une mesure
différente.

L'\textbf{approche monétaire} identifie la pauvreté à l'insuffisance du revenu
...
L'\textbf{approche par les besoins essentiels} y répond en dressant la liste
des biens et services jugés indispensables, et en déclarant pauvre celui qui
n'y accède pas. Elle déplace la mesure du revenu vers les conditions de vie,
mais laisse ouverte la question du choix des besoins retenus.

L'\textbf{approche relative} de \textcite{townsend1979} définit la privation
...
L'\textbf{approche par les capabilités} de \textcite{sen1985, sen1999} opère le
...
% ─────────────────────────────────────────────────────────────────────────────
\subsection{La pauvreté multidimensionnelle appliquée à l'enfant}
...
% ─────────────────────────────────────────────────────────────────────────────
\subsection{De la définition à la mesure : compter les privations}
% ─────────────────────────────────────────────────────────────────────────────
