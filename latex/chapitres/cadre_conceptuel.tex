...
L'approche monétaire identifie la pauvreté à l'insuffisance du revenu ou
de la consommation au regard d'un seuil. Le seuil peut être absolu, fixé
par le coût d'un panier de besoins jugés minimaux, comme le seuil national
que calcule l'ANSD à partir des dépenses de consommation, ou relatif,
défini en proportion du niveau de vie médian, convention des pays riches.
Dans les deux cas, la mesure procède du même geste : agréger les
ressources du ménage, les rapporter à sa taille par une échelle
d'équivalence, et comparer le résultat au seuil. Sa force est sa
simplicité et sa comparabilité, dans le temps comme entre pays, et c'est
elle qui structure le suivi international de la pauvreté. Sa faiblesse,
pour la question posée ici, est double : elle suppose que les ressources
se répartissent équitablement à l'intérieur du ménage, ce que rien
n'assure \parencite{deaton1997}, si bien que le bien-être propre de
l'enfant lui échappe~; et elle ignore ce que le revenu ne peut acheter
faute d'une offre disponible, une école ou un réseau d'assainissement,
alors que ces manques sont constitutifs de la pauvreté telle que la
définit le Sommet de Copenhague \parencite{onu1995}.

L'approche par les besoins essentiels y répond en renversant la
perspective : au lieu d'inférer le bien-être du revenu, elle dresse la
liste des biens et services jugés indispensables, alimentation, eau
potable, logement, santé, éducation, et déclare pauvre celui qui n'y
accède pas, quelle que soit sa position monétaire. Portée par
l'Organisation internationale du travail dans les années soixante-dix,
elle a durablement orienté les politiques de développement vers la
fourniture directe de services. C'est de cette tradition que procède la
mesure des privations des enfants développée par \textcite{gordon2003}
pour l'UNICEF, chaque besoin essentiel y devenant une dimension observée
avec ses seuils propres. Elle déplace ainsi la mesure du revenu vers les
conditions de vie, mais laisse ouvertes deux questions que les approches
suivantes affrontent : celle du choix des besoins retenus, et celle de
leur agrégation en un jugement d'ensemble.
...
L'approche par les capabilités de \textcite{sen1985, sen1999} opère
enfin le déplacement théorique décisif. Ce qui importe n'est ni le revenu
ni la possession de biens, mais la capacité effective d'une personne à
être et à faire ce qu'elle a des raisons de valoriser, être en bonne
santé, être instruit, participer à la vie de sa communauté. Le revenu
n'est plus qu'un moyen, dont le rendement en capacités varie d'un individu
et d'un contexte à l'autre : le même montant n'achète pas la même santé à
l'enfant d'un village sans dispensaire et à celui d'une ville qui en
dispose. Cette approche fonde théoriquement la mesure multidimensionnelle,
chaque dimension s'interprétant comme un fonctionnement essentiel, et elle
éclaire directement la question de ce mémoire : si le bien-être est fait
de capacités et non de ressources, un supplément de ressources privées,
les transferts, ne se convertit en bien-être de l'enfant que là où les
conditions de cette conversion, l'offre de services au premier chef, sont
réunies. C'est dans ce cadre que s'inscrit la mesure retenue ici.

Le passage de ces approches à une mesure opératoire doit beaucoup à la
famille d'indices de \textcite{alkire2011}, qui fournit la grammaire du
comptage : des dimensions, des seuils de privation propres à chacune, un
seuil inter-dimensionnel qui définit la pauvreté par le cumul, et des
indices, incidence, intensité, indice ajusté, qui en résument la
distribution. L'approche MODA mobilisée dans ce travail en est la
déclinaison propre à l'enfance.
