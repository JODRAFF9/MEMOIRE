...
\entete & 0-4 & 5-14 & 15-17 & 0-4 & 5-14 & 15-17 \\
    ...
    Surpeuplement\tnote{a}           & 26,5 & 25,6 & 23,5 & n.d. & n.d. & 11,4 \\ \hline
    Insécurité alimentaire           & 45,0 & 46,5 & 44,9 & 45,0 & 46,5 & 44,9 \\ \hline
    Combustible solide               & 92,3 & 92,3 & 91,5 & 92,3 & 92,3 & 91,5 \\ \hline
    Accès santé (pas à pied)         & 48,0 & 47,2 & 44,0 & 79,3 & 78,5 & 75,2 \\ \hline
    Acte de naissance                & 31,8 & 30,0 & -    & 31,8 & 30,1 & -    \\ \hline
    Travail des enfants              & -    & 41,8 & -    & -    & 43,0 & -    \\ \hline
    Séparation parentale\tnote{b}    & 36,5 & 43,0 & 52,8 & n.d. & n.d. & n.d. \\ \hline
    Non-scolarisation                & -    & 45,3 & -    & -    & 45,3 & -    \\ \hline
    Illettrisme                      & -    & -    & 28,1 & -    & -    & 28,1 \\ \hline
    NEET\tnote{c}                    & -    & -    & 33,7 & -    & -    & 85,7 \\
    \hline
  \end{tabular}
  \begin{tablenotes}
    \footnotesize
    \item[a] Surpeuplement~: calculé sur le nombre total de pièces (la variable
    « pièces pour dormir » de l'ANSD est absente de l'EHCVM), d'où un proxy
    non directement comparable à la valeur ANSD.
    \item[b] Séparation parentale (ne vit pas avec ses deux parents
    biologiques)~: retenu dans la dimension Protection~; l'ANSD ne publie pas
    de taux par groupe d'âge pour cet indicateur.
    \item[c] NEET~: la valeur ANSD (85,7\,\%) est incohérente avec le taux de
    scolarisation observé (un enfant NEET est nécessairement non scolarisé, or
    seuls 45,7\,\% des 15-17 ans le sont)~; l'agrégat retient notre
    opérationnalisation (33,7\,\%).
  \end{tablenotes}
  \end{threeparttable}
...
heure »). L'accès à une structure de santé (module communautaire) tient compte du filtre
du questionnaire~: à la question de l'existence du service (2.01), une réponse
affirmative saute la question du mode d'accès (2.02), qui n'est donc renseignée
que pour les services absents localement (trajet vers le plus proche). L'enfant
peut ainsi accéder à pied à une structure de santé si un hôpital ou un centre
de santé public existe dans sa localité (sur place) ou, à défaut, s'y rejoint à
pied~; il en est privé dans le cas contraire. L'écart avec l'ANSD tient à la
convention de dénominateur de cette dernière, qui rapporte l'indicateur aux
seules localités dépourvues de structure sur place. Deux indicateurs sont
retenus dans l'agrégat mais échappent à une comparaison directe avec l'ANSD~:
le surpeuplement, faute de la variable « pièces pour dormir » (calculé ici sur
le nombre total de pièces, d'où un proxy plus élevé que la valeur ANSD), et le
NEET des 15-17 ans, dont la valeur ANSD (85,7\,\%) est incohérente avec le taux
de scolarisation observé (un enfant NEET étant nécessairement non scolarisé,
alors que seuls 45,7\,\% des 15-17 ans le sont)~; l'agrégat retient notre
opérationnalisation du NEET (33,7\,\%). La séparation parentale, troisième
indicateur de la dimension Protection, n'a pas d'équivalent chiffré publié par
l'ANSD par groupe d'âge.
...
\entete Statistique & Ce mémoire & ANSD (MODA 2024) \\
    \hline
    Incidence $H$ (\%)         & 59,0  & 50,7  \\ \hline
    Intensité $A$ (\%)         & 70,5  & 72,2  \\ \hline
    Indice ajusté $M_0 = H \times A$ & 0,416 & 0,366 \\
    \hline
  \end{tabular}
...
L'écart d'incidence (59,0\,\% contre 50,7\,\%) s'explique par deux facteurs.
