...
successives, à savoir exploration des bases (\texttt{01\_visitation}), variable de
...
descriptives (\texttt{06\_stats\_desc}) et effets par dimension
(\texttt{07\_effets\_dim}). Toutes les valeurs reportées dans le
