\section{Code de mise en \oe{}uvre de l'estimateur par appariement et double différence}
\label{ann:B}
...
\subsection{Appariement par les plus proches voisins et équilibre}
...
\subsection{Estimateur par appariement et double différence}
