...
twoway (connected H_MODA annee, lcolor("31 78 121") mcolor("31 78 121") msymbol(circle)  lwidth(medthick)) ///
       (connected H_AF   annee, lcolor("230 126 34") mcolor("230 126 34") msymbol(diamond) lwidth(medthick)), ///
...
graph bar v2018 v2021, over(dim, sort(ordre) label(angle(30))) ///
    bar(1, color("31 78 121")) bar(2, color("230 126 34")) ///
...
histogram nb_dep [fw=fw], by(D, cols(1) note("") ///
    ...
    color("168 199 232") lcolor(white) ///
