...
twoway (connected temoin annee, lcolor(gs7) mcolor(gs7) msymbol(square) lwidth(medthick) ///
    ...
    xtitle("Vague EHCVM") ytitle("Incidence de la pauvreté (H, %)") ///
...
/* ============================================================
   ...
   Les statistiques de pauvrete/privation (incidence de la pauvreté multidimensionnelle, par dimension,
...
/* ============================================================
   3. Incidence de la pauvreté par édition, milieu, groupe d'âge
   ============================================================ */
...
/* ── Fig 1 : Évolution de l'incidence de la pauvreté multidimensionnelle, beneficiaires vs
...
twoway (connected H_nonbenef annee, lcolor(gs9) mcolor(gs9) msymbol(square) ///
    ...
    ytitle("Incidence de la pauvreté H (%)") ///
...
forvalues g = 0/3 {
    ...
    if `g' == 2 local lbl "5-14 ans"
    if `g' == 3 local lbl "15-17 ans"
    di _newline(2) "=== Incidence de la pauvreté multidimensionnelle par genre du chef et statut — `lbl' ==="
...
/* Incidence de la pauvreté multidimensionnelle par quintile de montant recu, pour l'ensemble des enfants
...
forvalues g = 0/3 {
    ...
    di _newline(2) "=== Incidence de la pauvreté multidimensionnelle par quintile de montant — `lbl' ==="
