...
# Modalites lieu de residence expediteur (variable differ entre vagues)
cat("\n>>> Modalites s13aq14 (lieu expediteur) — 2018:\n")
print(haven::as_factor(s13a2_2018$s13aq14) |> table(useNA = "ifany"))
cat("\n>>> Modalites s13q19 (lieu expediteur) — 2021:\n")
print(haven::as_factor(s13a2_2021$s13q19) |> table(useNA = "ifany"))
