...
\setbeamertemplate{title page}{%
  ...
  \begin{center}
    \vspace{-0.1cm}
    \raisebox{0.02cm}{\includegraphics[width=0.115\paperwidth,height=1.7cm]{prism-uploads/ENSAE.png}}%
    \hspace{1.1cm}%
    \raisebox{0.22cm}{\includegraphics[height=1.25cm]{figures/logo_itie.png}}\par
    \vspace{0.05cm}
    {\small\textcolor{gray!65!black}{École Nationale de la Statistique et de l'Analyse Économique Pierre Ndiaye}}\par
