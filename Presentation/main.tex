...
\begin{frame}{Contexte général}
  ...
  \begin{alertblock}{Pauvreté infantile : un défi persistant}
    \begin{itemize}
      \item Près de \textbf{64\,\%} des enfants souffrent de privations multiples (N-MODA, EHCVM I).
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Résultats N-MODA ($k=4$)}
        ...
        \begin{tabular}{lccc}
          ...
          Vague & $H$ & $A$ & $M_0$ \\
          \midrule
          2018-2019 & 59,8\,\% & 69,9\,\% & 0,418 \\
          2021-2022 & 51,0\,\% & 68,6\,\% & 0,349 \\
          \midrule
          $\Delta$ & $-8{,}8$ pp & $-1{,}3$ pp & $-0{,}069$ \\
          \bottomrule
        \end{tabular}
      \end{block}
      \begin{block}{Lecture}
...
\begin{frame}[label=privations-dim]{Privations par dimension (N-MODA)}
  ...
  \begin{alertblock}{Amélioration entre 2018 et 2022}
    Baisse de 8,8 pp de l'incidence N-MODA ;
...
\begin{frame}{Conclusion générale}
  \begin{block}{Principaux apports}
    \begin{enumerate}
      ...
      \pause
      \item L'incidence N-MODA recule de 59,8\,\% (2018) à 51,0\,\% (2021) :
