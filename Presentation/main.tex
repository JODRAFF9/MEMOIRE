...
\begin{frame}{Disparités régionales de la pauvreté N-MODA}
  \centering
  \includegraphics[width=0.92\linewidth]{figures/fig_carte_nmoda.pdf}
  \begin{alertblock}{Forte hétérogénéité spatiale}
    Dakar et l'ouest nettement moins touchés ; le sud et l'est
    (Kolda, Sédhiou, Tambacounda, Kédougou) concentrent les incidences
    les plus élevées, aux deux vagues.
  \end{alertblock}
\end{frame}
