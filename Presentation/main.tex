...
% -- Palette ENSAE (identique au rapport) -------------------
\definecolor{ensaeblue}{RGB}{31,78,121}     % bleu fonce ENSAE
\definecolor{ensaecyan}{RGB}{0,174,239}     % cyan ENSAE
\definecolor{ensaeorange}{RGB}{224,123,57}  % orange (accents)
% Remappage des anciens noms vers la charte ENSAE : tout le diaporama
% adopte ainsi les memes couleurs que le rapport.
\colorlet{marron}{ensaeblue}
\colorlet{marronmed}{ensaeblue!80}
\colorlet{dore}{ensaeorange}
\colorlet{dorepale}{ensaecyan!12}
\colorlet{mybronze}{ensaeblue}
...
\setbeamertemplate{title page}{%
  \begin{tikzpicture}[remember picture,overlay]
    \fill[ensaeblue!6] (current page.south west) rectangle (current page.north east);
    % bandeau superieur bleu ENSAE
    \fill[ensaeblue] (current page.north west) rectangle ([yshift=-0.95cm]current page.north east);
    ...
    \draw[ensaecyan,line width=1pt,rounded corners=12pt]
  ...
  \begin{center}
    ...
    % -- rangee des quatre structures : logo + nom --
    \begin{minipage}[b]{0.21\paperwidth}\centering
      \includegraphics[height=1.05cm]{figures/armoiries_senegal.png}\\[2pt]
      {\tiny\color{ensaeblue}République du Sénégal}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.21\paperwidth}\centering
      \includegraphics[height=0.95cm]{figures/logo_ansd.jpg}\\[2pt]
      {\tiny\color{ensaeblue}ANSD}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.21\paperwidth}\centering
      \includegraphics[height=0.90cm]{figures/logo_ensae_new.png}\\[2pt]
      {\tiny\color{ensaeblue}ENSAE Pierre Ndiaye}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.21\paperwidth}\centering
      \includegraphics[height=0.95cm]{figures/logo_itie.png}\\[2pt]
      {\tiny\color{ensaeblue}CN-ITIE}
    \end{minipage}\par
    \vspace{0.26cm}
    % -- encadre titre (bleu ENSAE, lisere cyan) --
    \begin{tikzpicture}
      \node[fill=ensaeblue,draw=ensaecyan,line width=0.8pt,rounded corners=8pt,
    ...
    \begin{minipage}[t]{0.43\paperwidth}\centering
      {\scriptsize\color{ensaeblue}\bfseries Présenté par :}\\[2pt]
      {\small Sié Rachid \textsc{Traoré}}\\[1pt]
      {\scriptsize\itshape Élève ingénieur statisticien économiste}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.43\paperwidth}\centering
      {\scriptsize\color{ensaeblue}\bfseries Sous la direction de :}\\[2pt]
    ...
    % -- date (pastille) --
    \begin{tikzpicture}
      \node[draw=ensaecyan,fill=ensaecyan!15,rounded corners=4pt,
            inner xsep=12pt,inner ysep=4pt,text=ensaeblue,font=\small\bfseries]
        {\insertdate};
    \end{tikzpicture}
  \end{center}%
}
...
\begin{frame}[label=maps-spatial]{Taux de privation régionale}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_nmoda.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : assainissement}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_dim_assai.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : eau}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_dim_eau.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : logement}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_dim_logem.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : nutrition}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_dim_nutri.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : santé}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_dim_sante.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : protection}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_dim_protect.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : éducation}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/fig_carte_dim_educ.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}[label=distrib-dimensions]{Distribution du nombre de dimensions en privation}
  \centering
  \includegraphics[width=0.72\linewidth]{figures/fig_distrib_dimensions.pdf}\\[0.1cm]
