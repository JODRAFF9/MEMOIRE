    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Résultats N-MODA ($k=4$)}
        ...
        \begin{tabular}{lccc}
          ...
          Vague & $H$ & $A$ & $M_0$ \\
          \midrule
          2018-2019 & 56,4\,\% & 69,5\,\% & 0,392 \\
          2021-2022 & 48,3\,\% & 68,2\,\% & 0,330 \\
          \midrule
          $\Delta$ & $-8{,}1$ pp & $-1{,}3$ pp & $-0{,}062$ \\
          \bottomrule
        \end{tabular}
      \end{block}
      \begin{block}{Lecture}
...
\begin{frame}[label=privations-dim]{Privations par dimension (N-MODA)}
  ...
  \begin{alertblock}{Amélioration entre 2018 et 2022}
    Baisse de 8,1 pp de l'incidence N-MODA ;
...
\begin{frame}{Impact des transferts sur la pauvreté multidimensionnelle}
  ...
  \begin{table}
    ...
    \begin{tabular}{lccc}
      ...
      \midrule
      DD brute (sans appariement)      & $-0{,}005$ & (0,022) & 0,834 \\
      \textbf{PSM-DD, k-NN ($k=4$)}   & $\mathbf{-0{,}001}$ & (0,025) & \textbf{0,959} \\
      PSM-DD, noyau Epanechnikov       & $-0{,}001$ & (0,025) & 0,967 \\
      PSM-DD, caliper                  & $-0{,}007$ & (0,028) & 0,798 \\
      \bottomrule
    \end{tabular}
  \end{table}
...
\begin{frame}{Tests de robustesse}
  \begin{block}{Sensibilité des résultats}
    \begin{itemize}
      ...
      \item Panel d'enfants (mêmes enfants suivis entre les vagues) :
            ATT $= -0{,}015$ ($p=0{,}521$), pas d'artefact de composition par âge.
  ...
  \begin{alertblock}{Définition alternative : les bénéficiaires durables}
    ...
    ($0{,}041$, $p=0{,}104$) : les effets des transferts, dans un sens comme
...
\begin{frame}{Validation des hypothèses - Synthèse}
  \begin{table}
    ...
    \begin{tabular}{c p{3.5cm} p{5.5cm} c}
      ...
      \midrule
      H1 & Réduction de la pauvreté & ATT N-MODA $= -0{,}001$ ($p=0{,}959$) : pas d'effet à court terme & Non rejet de $H_0$ \\[4pt]
...
\begin{frame}{Conclusion générale}
  \begin{block}{Principaux apports}
    \begin{enumerate}
      ...
      \pause
      \item L'incidence N-MODA recule de 56,4\,\% (2018) à 48,3\,\% (2021) :
