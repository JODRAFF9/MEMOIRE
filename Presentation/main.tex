...
\begin{frame}{Contexte général}
  ...
  \begin{alertblock}{Pauvreté infantile : un défi persistant}
    \begin{itemize}
      \item Plus de \textbf{56\,\%} des enfants souffrent de privations multiples (N-MODA, EHCVM I).
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Résultats N-MODA ($k=4$)}
        ...
        \begin{tabular}{lccc}
          ...
          Vague & $H$ & $A$ & $M_0$ \\
          \midrule
          2018-2019 & 56,6\,\% & 69,5\,\% & 0,393 \\
          2021-2022 & 48,8\,\% & 68,2\,\% & 0,333 \\
          \midrule
          $\Delta$ & $-7{,}8$ pp & $-1{,}3$ pp & $-0{,}060$ \\
          \bottomrule
        \end{tabular}
      \end{block}
      \begin{block}{Lecture}
...
\begin{frame}[label=privations-dim]{Privations par dimension (N-MODA)}
  ...
  \begin{alertblock}{Amélioration entre 2018 et 2022}
    Baisse de 7,8 pp de l'incidence N-MODA ;
    plus d'un enfant sur deux reste privé dans au moins 4 dimensions.
  \end{alertblock}
  \begin{center}
    \hyperlink{maps-spatial}{\beamergotobutton{Voir les distributions spatiales}}
    ...
    \begin{column}{0.46\textwidth}
      \begin{block}{Équilibre après appariement ($k$-NN, $k=4$)}
        \begin{itemize}
          ...
          \item Différence standardisée moyenne (SMD) : 7,7\,\% avant, \textbf{1,4\,\%}
                après appariement.
          \item ménages bénéficiaires, tous sur support commun, appariés à
...
\begin{frame}{Impact des transferts sur la pauvreté multidimensionnelle}
  ...
  \begin{table}
    ...
    \begin{tabular}{lccc}
      ...
      \midrule
      DD brute (sans appariement)      & $-0{,}005$ & (0,022) & 0,835 \\
      \textbf{PSM-DD, k-NN ($k=4$)}   & $\mathbf{-0{,}001}$ & (0,025) & \textbf{0,961} \\
      PSM-DD, noyau Epanechnikov       & $-0{,}001$ & (0,025) & 0,968 \\
      PSM-DD, caliper                  & $-0{,}007$ & (0,028) & 0,808 \\
      \bottomrule
    \end{tabular}
  \end{table}
...
\begin{frame}{Effets par dimension de la pauvreté}
  ...
  \begin{columns}
    ...
    \begin{column}{0.43\textwidth}
      \begin{alertblock}{Deux canaux opposés qui se compensent}
        \begin{itemize}
          \item \textbf{Éducation} : $-3{,}9$ pp ($p=0{,}005$),
                seule dimension en amélioration significative.
          \item \textbf{Protection de l'enfant} : $+5{,}1$ pp
                ($p=0{,}003$), dégradation liée à la séparation
  ...
  \begin{block}{Lecture : preuve directe du mécanisme de compensation}
    ...
    l'absence parentale. Pas de différence significative par sexe ni âge~;
    milieu à la limite ($p=0{,}053$, dynamique rurale plus favorable non concluante).
  \end{block}
\end{frame}
...
\begin{frame}{Tests de robustesse}
  \begin{block}{Sensibilité des résultats}
    \begin{itemize}
      ...
      \item Panel d'enfants (mêmes enfants suivis entre les vagues) :
            ATT $= -0{,}014$ ($p=0{,}579$), pas d'artefact de composition par âge.
      \item Test placebo (200 assignations aléatoires) : l'ATT réel se situe au
            50\textsuperscript{e} centile de la distribution placebo,
  ...
  \begin{alertblock}{Définition alternative : les bénéficiaires durables}
    ...
    base), la dynamique relative est défavorable, quoique non significative
    ($0{,}038$, $p=0{,}126$) : les effets des transferts, dans un sens comme
...
\begin{frame}{Validation des hypothèses - Synthèse}
  \begin{table}
    ...
    \begin{tabular}{c p{3.5cm} p{5.5cm} c}
      ...
      \midrule
      H1 & Réduction de la pauvreté & ATT N-MODA $= -0{,}001$ ($p=0{,}961$) : pas d'effet à court terme & Non rejet de $H_0$ \\[4pt]
      H2 & Hétérogénéité des effets  & Éducation favorable vs protection dégradée ; rien de significatif par sexe/âge, milieu à la limite ($p=0{,}053$) & Partiellement \\[4pt]
...
\begin{frame}{Conclusion générale}
  \begin{block}{Principaux apports}
    \begin{enumerate}
      ...
      \pause
      \item L'incidence N-MODA recule de 56,6\,\% (2018) à 48,8\,\% (2021) :
...
\begin{frame}[label=maps-spatial]{Taux de privation régionale}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_nmoda.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : assainissement}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_dim_assai.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : eau}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_dim_eau.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : logement}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_dim_logem.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : nutrition}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_dim_nutri.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : santé}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_dim_sante.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : protection}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_dim_protect.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : éducation}
  \centering
  \includegraphics[height=0.74\textheight,keepaspectratio]{figures/fig_carte_dim_educ.pdf}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}
