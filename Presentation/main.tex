...
% ============================================================
% ANNEXE : distributions spatiales (cartes)
% ============================================================
\appendix

\begin{frame}[label=maps-spatial]{Distribution spatiale de la pauvreté N-MODA}
  \centering
  \includegraphics[width=0.92\linewidth]{figures/fig_carte_nmoda.pdf}

  \smallskip
  {\footnotesize Dakar et l'ouest moins touchés ; le sud et l'est
  (Kolda, Sédhiou, Tambacounda, Kédougou) concentrent les incidences les
  plus élevées.}\\[0.2cm]
