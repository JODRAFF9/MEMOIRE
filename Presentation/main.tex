...
\begin{frame}{Taux de privation par dimension : assainissement et eau}
  \begin{columns}
    \begin{column}{0.5\textwidth}\centering
      \includegraphics[width=\linewidth]{figures/fig_carte_dim_assai.pdf}\\
      {\scriptsize Assainissement}
    \end{column}
    \begin{column}{0.5\textwidth}\centering
      \includegraphics[width=\linewidth]{figures/fig_carte_dim_eau.pdf}\\
      {\scriptsize Eau}
    \end{column}
  \end{columns}
  \hfill\hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : logement et nutrition}
  \begin{columns}
    \begin{column}{0.5\textwidth}\centering
      \includegraphics[width=\linewidth]{figures/fig_carte_dim_logem.pdf}\\
      {\scriptsize Logement}
    \end{column}
    \begin{column}{0.5\textwidth}\centering
      \includegraphics[width=\linewidth]{figures/fig_carte_dim_nutri.pdf}\\
      {\scriptsize Nutrition}
    \end{column}
  \end{columns}
  \hfill\hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}

\begin{frame}{Taux de privation par dimension : santé et protection}
  \begin{columns}
    \begin{column}{0.5\textwidth}\centering
      \includegraphics[width=\linewidth]{figures/fig_carte_dim_sante.pdf}\\
      {\scriptsize Santé}
    \end{column}
    \begin{column}{0.5\textwidth}\centering
      \includegraphics[width=\linewidth]{figures/fig_carte_dim_protect.pdf}\\
      {\scriptsize Protection}
    \end{column}
  \end{columns}
  \hfill\hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}
...
\begin{frame}{Taux de privation par dimension : éducation}
  \centering
  \includegraphics[width=0.7\linewidth]{figures/fig_carte_dim_educ.pdf}\\
  {\scriptsize Éducation}\\[0.2cm]
  \hyperlink{privations-dim}{\beamerreturnbutton{Retour}}
\end{frame}
