...
\colorlet{dorepale}{presvertc!12}
...
\begin{frame}[shrink]{Objectifs et hypothèses}
...
\begin{frame}[label=privations-dim,shrink]{Privations par dimension (N-MODA)}
  \begin{columns}
    \begin{column}{0.50\textwidth}
      \centering
...
\begin{frame}[shrink]{Effets par dimension de la pauvreté}
  \begin{columns}
