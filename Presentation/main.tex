...
% -- Palette vert / or (sans bleu) --------------------------
\definecolor{presvert}{RGB}{27,94,60}    % vert fonce (couleur principale)
\definecolor{presvertc}{RGB}{72,160,110} % vert clair
\definecolor{presor}{RGB}{201,148,42}    % or / dore (accents)
% Remappage des anciens noms vers la palette verte : tout le diaporama
% adopte ainsi une charte verte et doree, sans bleu.
