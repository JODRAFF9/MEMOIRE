...
\begin{frame}{Contexte général}
  ...
  \begin{alertblock}{Pauvreté infantile : un défi persistant}
    \begin{itemize}
      \item Plus de \textbf{62\,\%} des enfants souffrent de privations multiples (N-MODA, EHCVM I).
...
\begin{frame}{N-MODA : 7 dimensions, 3 groupes d'âge}
  ...
  \end{alertblock}
  \begin{center}
    \hyperlink{matrice-nmoda}{\beamergotobutton{Voir la matrice N-MODA complète}}
  \end{center}
\end{frame}
...
\begin{frame}[label=privations-dim]{Privations par dimension (N-MODA)}
  \small
  \begin{columns}
    \begin{column}{0.50\textwidth}
      \centering
  ...
  \begin{alertblock}{Bénéficiaires vs non-bénéficiaires : des trajectoires parallèles}
    Baisse de 7,5 pp de l'incidence N-MODA entre les deux vagues. L'avantage
...
\begin{frame}{Validation des hypothèses - Synthèse}
  \begin{table}
    ...
    \begin{tabular}{c p{3.5cm} p{5.5cm} c}
      ...
      \midrule
      H1 & Réduction de la pauvreté & ATT N-MODA $= 0{,}043$ ($p=0{,}119$) : pas d'effet établi à court terme & Non validée \\[4pt]
...
\begin{frame}{Conclusion générale}
  \begin{block}{Principaux apports}
    \begin{enumerate}
      ...
      \pause
      \item L'incidence N-MODA recule de 62,8\,\% (2018) à 55,3\,\% (2021) :
...
% ============================================================
% ANNEXE : matrice N-MODA complète + distributions spatiales
% ============================================================
\appendix

\begin{frame}[label=matrice-nmoda]{Matrice N-MODA complète : indicateurs, âges, sources et seuils}
  \centering
  \resizebox{\textwidth}{!}{%
