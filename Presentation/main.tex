...
\begin{frame}[shrink=10]{IPM-Alkire-Foster complémentaire}
...
\begin{frame}{Privations par dimension (N-MODA)}
  ...
  \begin{block}{Résultats N-MODA (7 dimensions, $k=4$)}
    \centering\smallskip
    \begin{tabular}{lccc}
      \toprule
      Vague & Incidence $H$ & Intensité $A$ & $M_0 = H \times A$ \\
      \midrule
      EHCVM I (2018--2019)  & 58,9\,\% & 60,2\,\% & 35,5\,\% \\
      EHCVM II (2021--2022) & 51,6\,\% & 59,8\,\% & 30,9\,\% \\
      \midrule
      Variation             & $-7{,}3$ pp & $-0{,}4$ pp & $-4{,}6$ pp \\
      \bottomrule
    \end{tabular}
  \end{block}
  \begin{block}{Résultats Alkire-Foster (6 indicateurs, $k=1/3$)}
    \centering\smallskip
    \begin{tabular}{lc}
      \toprule
      Vague & Incidence $H$ \\
      \midrule
      EHCVM I (2018--2019)  & 62,0\,\% \\
      EHCVM II (2021--2022) & 56,3\,\% \\
      \bottomrule
    \end{tabular}
  \end{block}
\end{frame}
...
\begin{frame}{Privations par dimension (N-MODA)}
  \begin{block}{Dimensions les plus répandues en 2018--2019}
    \begin{itemize}
      \item Assainissement : dimension la plus touchée (toilettes non améliorées ou partagées).
      \item Eau : accès à une source non améliorée ou temps d'accès excessif.
      \item Logement : surpeuplement et gestion des ordures non saine.
      \item Éducation : non-scolarisation et illettrisme chez les 15--17 ans.
    \end{itemize}
  \end{block}
  \begin{alertblock}{Amélioration entre 2018 et 2022}
    Baisse de 7,3 points de pourcentage de l'incidence N-MODA ;
    la pauvreté multidimensionnelle reste massive :
    plus d'un enfant sur deux est encore privé dans au moins 4 dimensions.
  \end{alertblock}
\end{frame}
...
\begin{frame}{Qualité de l'appariement PSM}
  ...
  \begin{block}{Vérification du support commun}
    ...
    chevauchement satisfaisant entre ménages traités et témoins.
  \end{block}
  \begin{block}{Équilibre des covariables après appariement}
    \begin{itemize}
      ...
      \item Ratio de variance proches de 1 pour les variables continues.
      \item Hypothèse d'ignorabilité conditionnelle satisfaite.
    \end{itemize}
  \end{block}
\end{frame}
