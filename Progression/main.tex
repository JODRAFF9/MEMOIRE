...
\AddToShipoutPictureBG{%
  \AtPageLowerLeft{%
    \begin{tikzpicture}[overlay, line cap=round, line join=round]
      ...
      % equerres orange dans les quatre angles (accent discret)
      \def\L{16pt}
      \draw[ensaeorange, line width=1.4pt, rounded corners=5pt]
        ($(SW)+(0,\L)$) -- ($(SW)+(0,6pt)$) arc (180:270:6pt) -- ($(SW)+(\L,0)$);
      \draw[ensaeorange, line width=1.4pt, rounded corners=5pt]
        ($(SE)+(0,\L)$) -- ($(SE)+(0,6pt)$) arc (0:-90:6pt) -- ($(SE)+(-\L,0)$);
      \draw[ensaeorange, line width=1.4pt, rounded corners=5pt]
        ($(NW)+(0,-\L)$) -- ($(NW)+(0,-6pt)$) arc (180:90:6pt) -- ($(NW)+(\L,0)$);
      \draw[ensaeorange, line width=1.4pt, rounded corners=5pt]
        ($(NE)+(0,-\L)$) -- ($(NE)+(0,-6pt)$) arc (0:90:6pt) -- ($(NE)+(-\L,0)$);
    \end{tikzpicture}%
  }%
}
